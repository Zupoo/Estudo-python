...
def bateram_meta (meta, vendas):
    ...
    for vendedor in vendas:
        if vendas[vendedor] > meta:
            bateram_meta[vendedor] = vendas[vendedor]
    porcentagem = (len(bateram_meta) / len(vendas)) * 100
    return bateram_meta, porcentagem
vendedores_bateram_meta, porcentagem_bateram_meta = bateram_meta(meta, vendas)
print(list(vendedores_bateram_meta.keys()))
print(porcentagem_bateram_meta)