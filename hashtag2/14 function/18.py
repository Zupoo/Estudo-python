...
def listar_produtos (*listas):
    ...
    for lista in listas:
        for item in lista:
            codigo_produto.append(item[0])
    codigo_produto = set(codigo_produto)        
    codigo_produto = list(codigo_produto)
    return codigo_produto            

codigo_todos_produtos = listar_produtos(estoque_fim_jan, estoque_fim_fev, estoque_fim_mar, estoque_fim_abr)
print(codigo_todos_produtos)